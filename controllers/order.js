...
exports.create = (req, res) => {
    ...
    let HelperOptions2 ={
        ...
        subject : "Your order on BookSMart was successful",
        text : "Hello " + req.profile.name + ", \n\nYou have successfully made purchase of Rs. " + req.body.order.amount + "on BookSMart. Please check your dashboard to track the status of your order.\n\nRegards, \nBookSMart"
    };
